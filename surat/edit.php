        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">    
                    ...
                    <input type="text" name="nomor_surat" class="form-control" value="<?php echo $result['nomor_surat']?>">
                </div>
                ...
                <div class= "form-group">
                    ...
                    <input type="text" name="pengirim" class="form-control" value="<?php echo $result['pengirim']?>">
                </div>
                
                <div class= "form-group">
                    <label for="penerima">penerima</label>
                    <input type="text" name="penerima" class="form-control" value="<?php echo $result['penerima']?>">
                </div>
                
                <div class= "form-group">
                    <label for="nomor_agenda">Nomor Agenda</label>
                    <input type="text" name="nomor_agenda" class="form-control" value="<?php echo $result['nomor_agenda']?>">
                </div>
